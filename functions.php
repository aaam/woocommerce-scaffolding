...
require_once(SCAFFOLDING_INCLUDE_PATH.'woocommerce.php');
...
function scaffolding_scripts_and_styles() {
	...
	//adding WooCommerce scripts file in the footer
	wp_enqueue_script( 'scaffolding-woocommerce-js', get_stylesheet_directory_uri() . '/js/woocommerce.js', array( 'jquery' ), '', true );
}
